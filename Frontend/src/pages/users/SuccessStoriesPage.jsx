...
export default function SuccessStoriesPage({ setIsAuthPanelOpen }) {
  ...
  const stories = [
    {
      ...
      experience: "15+ years",
      image:
        "https://images.unsplash.com/photo-1540555700478-4be289fbecee?w=400&q=80",
      quote:
        "SkillHub changed my life. I went from looking for daily wage work to having a steady stream of high-paying customers every week. My family finally has financial security.",
      location: "Bangalore",
    ...
    },
    {
      ...
      experience: "8 years",
      image:
        "https://images.unsplash.com/photo-1594744803329-a584af1cae24?w=400&q=80",
      quote:
        "The booking system is so easy to use. I can manage my bridal bookings months in advance without any stress. The app handles everything so I can focus on my art.",
      location: "Delhi",
    ...
    },
    {
      ...
      quote:
        "The trust people have in SkillHub makes my job easier. I don't have to convince customers about my quality; my ratings do it for me. I've doubled my client list.",
      location: "Mumbai",
  ...
  return (
    <div className="min-h-screen bg-background">
      <main>
        {/* Cinematic Hero */}
        <section className="relative min-h-[60vh] flex flex-col md:flex-row pt-5 items-center overflow-hidden bg-slate-900 text-white">
          ...
          <div className="container max-w-6xl mx-auto px-6 relative z-20">
            <div className="max-w-2xl">
              ...
              >
                Discover how everyday professionals are transforming their
                skills into successful independent businesses on SkillHub.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            className="md:absolute mb-4 sticky w-[80%] md:w-auto md:bottom-10 md:right-10 xl:flex flex-col items-center bg-white/60 p-6 rounded-3xl shadow-2xl text-slate-900 border-4 border-blue-600"
          >
            <Zap className="w-8 h-8 text-blue-600 mb-2 animate-bounce" />
            <span className="text-3xl font-black">₹0</span>
            <span className="text-[10px] font-bold text-slate-600 ml-2 uppercase tracking-widest">
              Sign-up Fees
            </span>
          </motion.div>
        </section>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {stats.map((stat, i) => (
                ...
                >
                  ...
                  <h3 className="md:text-3xl text-xl font-black mb-1">
                    {stat.value}
                  </h3>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
              <div className="max-w-xl">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Join a community of 50,000+ professionals who have found their
                  calling on SkillHub.
                </p>
              </div>
                  ...
                  <Card className="overflow-hidden h-full flex flex-col justify-between group hover:shadow-2xl shadow-blue-300 dark:shadow-blue-950 transition-all border bg-slate-50 dark:bg-slate-900/40 rounded-[40px]">
                    <>
                      <div className="aspect-4/5 overflow-hidden relative">
                        <div className="absolute top-6 left-6 flex flex-wrap gap-2">
                          {story.tags.map((tag, idx) => (
                            <span
                              key={idx}
                              className="px-4 py-1.5 rounded-full bg-white/90 backdrop-blur-sm text-slate-900 text-[10px] font-black uppercase tracking-widest shadow-xl"
                            >
                              {tag}
                            </span>
                          ))}
                      ...
                      <div className="p-8 flex flex-col gap-5 items-center">
                        <div className="flex flex-wrap gap-8 pb-6 border-b border-slate-200 dark:border-slate-800">
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-[8px] text-slate-400 uppercase font-bold tracking-widest mt-1">
                              MONTHLY REVENUE
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="flex justify-center">
                      <Button className="w-[80%] h-14 relative bottom-0 rounded-2xl bg-white dark:bg-slate-800 text-slate-900 dark:text-white border-2 border-slate-100 dark:border-slate-700 hover:bg-slate-900 hover:text-white transition-all group/btn font-bold">
                        Read Full Journey
        ...
        <section className="py-24 px-6 bg-blue-600 overflow-hidden relative">
          ...
          <div className="container max-w-5xl mx-auto relative z-10 text-white">
            <h2 className="text-4xl font-black text-center mb-16">
              The Journey to Platinum Status
            </h2>
                ...
                {[
                  {
                    icon: <Zap />,
                    label: "Onboard",
                    desc: "Pass verification and list your first service.",
                  },
                  {
                    icon: <CheckCircle2 />,
                    label: "First 10 Jobs",
                    desc: "Build your reputation with high-quality work.",
                  },
                  {
                    icon: <Award />,
                    label: "Silver Tier",
                    desc: "Unlock priority matching and better visibility.",
                  },
                  {
                    icon: <Trophy />,
                    label: "Platinum",
                    desc: "The elite 1%. Unlimited growth potential.",
                  },
                ].map((step, i) => (
                  <motion.div
                    key={i}
            ...
            <Card className="p-12 md:p-20 rounded-[60px] bg-slate-900 text-white text-center overflow-hidden relative">
              ...
              >
                ...
                <p className="text-xl text-slate-400 mb-12 max-w-2xl mx-auto">
                  Sign up today and start receiving high-intent leads in your
                  local area. No hidden fees, no upfront costs.
                </p>
