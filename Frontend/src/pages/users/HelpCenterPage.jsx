...
import {
    Search, ChevronDown, MessageSquare, Shield,
    CreditCard, User, HelpCircle, Mail, Phone,
    LifeBuoy, BookOpen, ExternalLink, ArrowRight
} from 'lucide-react';
...
const FAQ_DATA = [
    {
        ...
        answer: "Simply search for the skill you need, select a professional provider, choose your preferred time slot, and confirm your booking with a secure payment."
    },
    {
        question: "What is your cancellation policy?",
        answer: "You can cancel any booking up to 24 hours before the scheduled time for a full refund. Cancellations within 24 hours may be subject to a small processing fee."
    },
    {
        question: "How are providers verified?",
        answer: "Every provider on SkillHub undergoes a multi-step verification process, including identity checks, professional certifications, and a review of their past work history."
    },
    {
        question: "Is my payment secure?",
        answer: "Yes, all payments are processed through our secure encryption system. We hold funds in escrow until the service is completed to your satisfaction."
    },
    {
        question: "What if I'm not satisfied with the service?",
        answer: "If you're not happy with the service, please contact our support team within 48 hours of completion, and we'll work with you to resolve the issue, which may include a refund or rebooking."
    },
];
                    ...
                    <div className="grid lg:grid-cols-3 gap-12 items-start">
                        ...
                        <div className="space-y-6">
                            <Card className="p-8 bg-slate-900 text-white border-none relative overflow-hidden">
                                ...
                                <h3 className="text-xl font-bold mb-4 relative z-10">Still need help?</h3>
                                ...
                                <div className="space-y-4 relative z-10">
                                    ...
                                    <Button variant="outline" className="w-full border-white/20 hover:bg-white/10 text-white font-bold h-12 rounded-xl">
                            ...
                            <div className="p-6 rounded-3xl bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/20">
                                <h4 className="font-bold text-sm uppercase tracking-widest text-blue-600 mb-4">Quick Links</h4>
