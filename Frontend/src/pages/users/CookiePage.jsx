          ...
          >
            <div className="flex items-center gap-6 mb-12">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">Managing your digital experience</p>
              </div>
            </div>
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none space-y-12">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-8 not-prose mt-8">
                  <Card className="p-8 border-slate-100 dark:border-slate-800">
                    ...
                    <h4 className="font-bold text-lg mb-3">Essential Cookies</h4>
                    <p className="text-sm text-muted-foreground">Required for the platform to function properly, such as authentication and security features.</p>
                  </Card>
                  <Card className="p-8 border-slate-100 dark:border-slate-800">
                    <div className="w-12 h-12 rounded-xl bg-purple-100 text-purple-600 flex items-center justify-center mb-6">
                      <Settings className="w-6 h-6" />
                    </div>
                    <h4 className="font-bold text-lg mb-3">Preference Cookies</h4>
                    <p className="text-sm text-muted-foreground">Allow us to remember your settings like language, location, and dark mode preferences.</p>
                  </Card>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Most web browsers allow you to control cookies through their settings. However, disabling certain cookies may limit your ability to use some features of the SkillHub platform.
                </p>
              ...
              <section className="bg-slate-50 dark:bg-slate-900/40 p-8 rounded-3xl border border-slate-100 dark:border-slate-800">
                ...
                <p className="text-sm text-muted-foreground mb-6">If you have any questions about our use of cookies, please contact our support team.</p>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2 text-sm font-medium"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> Transparent tracking</li>
                  <li className="flex items-center gap-2 text-sm font-medium"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> Secure data storage</li>
                </ul>
              </section>
            </div>
          </motion.div>
