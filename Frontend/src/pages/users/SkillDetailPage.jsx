            ...
            <MotionCard className="p-6 bg-card border-2 border-border/40 shadow-lg">
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between space-x-4 text-muted-foreground mb-2">
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="truncate max-w-35 md:max-w-70">
                          {provider?.location}
                        </span>
                      </div>
                      <div className="flex items-center space-x-1">
                        <Clock className="w-4 h-4" />
                        <span className="truncate max-w-16 md:max-w-40">
                          {provider?.responseTime || "N/A"} response time
                        </span>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <MotionP
                  ...
                  className={`text-muted-foreground leading-relaxed ${expanded ? "" : "line-clamp-4"}`}
                >
                  {provider?.bio}
                </MotionP>
                <button
                      ...
                      >
                        {reviews.map((review) => (
                          <motion.div
                            key={review.id}
                            variants={listItem}
                            className="pb-4 border-b border-border/30 last:border-b-0"
                          >
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Fully licensed contractor with liability insurance
                          </p>
                        </div>
                      </div>
                      <Separator />
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Successfully completed projects with high
                            satisfaction
                          </p>
                        </div>
                      </div>
            ...
            >
              <div className="text-center mb-6">
                <p className="text-3xl font-bold text-(--primary-gradient-start) mb-1">
                  ₹{provider?.hourlyRate}/
                  {provider?.rateType === "hourly"
                    ? "hr"
                    : provider?.rateType === "perday"
                      ? "day"
                      : "job"}
                </p>
