        ...
        <section className="relative py-24 bg-slate-900 text-white overflow-hidden">
          ...
          <div className="container max-w-5xl mx-auto px-6 text-center relative z-10">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              We're building a community based on trust, respect, and
              professional excellence. These guidelines help ensure a positive
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {guidelines.map((g, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Card className="p-8 h-full hover:shadow-xl transition-all border-border/60 bg-slate-50 dark:bg-slate-900/40 rounded-3xl group">
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex gap-4 p-4 rounded-2xl bg-white dark:bg-slate-800 shadow-sm"
                    >
        ...
        <section className="py-24 px-6">
          <div className="container max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
              Our community relies on users like you to maintain high standards.
