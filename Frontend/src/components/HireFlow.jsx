...
export function HireFlow({ providerId, onComplete, onBack, user }) {
              ...
              <React.Fragment key={step}>
                ...
                {step < 3 && (
                  <div className={`w-16 h-0.5 mx-2 ${
                    step < currentStep ? 'bg-[var(--primary-gradient-start)]' : 'bg-border'
                  }`} />
                )}
              </React.Fragment>
            ))}
                ...
                {currentStep === 3 && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <Card className="p-4 border-[var(--primary-gradient-start)]/30 bg-[var(--primary-gradient-start)]/5">
                        <div className="flex items-center space-x-3">
                          <CreditCard className="w-5 h-5 text-[var(--primary-gradient-start)]" />
                          <div>
                ...
                {estimatedCost > 0 && (
                  <>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold text-[var(--primary-gradient-start)]">${estimatedCost}</p>
