...
import { skills, providers } from '../data/mockData.js'
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-20 items-center justify-between px-6 mx-auto">
          <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-br from-[var(--primary-gradient-start)] to-[var(--primary-gradient-end)] rounded-xl flex items-center justify-center text-white shadow-lg">
      ...
      <section className="relative pt-24 pb-20 px-6 overflow-hidden">
        ...
        <div className="container max-w-5xl mx-auto text-center relative z-10">
          <h1 className="text-6xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-[var(--primary-gradient-start)] to-[var(--primary-gradient-end)] bg-clip-text text-transparent leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-3xl mx-auto mb-12">
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-12 h-14 text-lg bg-card border-2 border-border/60 shadow-lg focus:shadow-xl focus:border-[var(--primary-gradient-start)] transition-all duration-200"
              />
            </div>
            <Button 
              onClick={handleSearch}
              className="h-14 px-10 text-lg bg-gradient-to-r from-[var(--primary-gradient-start)] to-[var(--primary-gradient-end)] text-white shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
            >
              Find Skills
            </Button>
          </div>
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              <MapPin className="w-5 h-5 text-[var(--primary-gradient-start)]" />
              <span>50+ Cities</span>
            </div>
          </div>
        </div>
      ...
      {/* Featured Skills */}
      <section className="py-20 px-6 bg-gradient-to-b from-secondary/30 to-secondary/50">
        <div className="container max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-16">
            {skills.slice(0, 8).map((skill) => (
              <Card 
                key={skill.id}
                className="group p-8 cursor-pointer hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 bg-card border-2 border-border/40 hover:border-[var(--primary-gradient-start)]/30 relative overflow-hidden"
          ...
          <div className="text-center">
            <Button
              ...
              className="px-10 py-3 text-lg border-2 hover:border-[var(--primary-gradient-start)] hover:bg-[var(--primary-gradient-start)]/10 transition-all duration-200"
            >
              View All Skills
            </Button>
          </div>
      ...
      {/* Features Section */}
      <section className="py-16 bg-gradient-to-br from-surface/20 to-background">
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-secondary/20 via-background to-secondary/20" />
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group">
              <div className="relative mb-6">
                <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br from-[var(--primary-gradient-start)] to-[var(--primary-gradient-end)] flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300">
      ...
      {/* Footer */}
      <footer className="py-12 px-6 border-t bg-secondary/50">
