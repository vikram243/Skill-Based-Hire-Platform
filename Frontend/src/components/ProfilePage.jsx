...
export function ProfilePage({ onNavigate, user, onLogout, isDarkMode = false, onToggleDarkMode }) {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <Card className="p-6 text-center bg-gradient-to-br from-card to-[var(--surface)] border-2 border-border/40 shadow-[var(--shadow-mid)]">
                <div className="relative inline-block mb-4">
                  <Avatar className="w-24 h-24 border-4 border-background shadow-lg">
                    <AvatarImage src="/api/placeholder/96/96" />
                    <AvatarFallback className="text-xl bg-gradient-to-br from-[var(--primary-gradient-start)] to-[var(--primary-gradient-end)] text-white">
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  {stats.slice(0, 2).map((stat, index) => (
                    <div key={index}>
                      <div className="font-bold text-lg text-[var(--primary-gradient-start)]">
                        {stat.value}
                      </div>
                  ...
                  <Card className="p-6">
                    ...
                    <div className="space-y-4">
                      {recentActivity.map((activity, index) => (
                        <div key={index} className="flex items-center justify-between p-4 rounded-lg bg-[var(--surface)] border border-border/40">
                          <div className="flex items-center gap-3">
                            <div className={`w-2 h-2 rounded-full ${
                              activity.type === 'completed' ? 'bg-success' : 'bg-[var(--primary-gradient-start)]'
                            }`} />
                            <div>
