...
export function SkillDetailPage({ providerId, onNavigate, onBack, user }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br pb-16 from-background via-surface/30 to-background authenticated-page">
      <Navigation 
        onNavigate={onNavigate} 
        user={user}
        isAuthenticated={!!user}
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-6 bg-card border-2 border-border/40 shadow-lg">
              <div className="flex justify-between">
                <Avatar className="h-20 w-20 ring-4 ring-[var(--primary-gradient-start)]/20">
                    <AvatarImage src={provider.avatar} alt={provider.name} />
                    <AvatarFallback className="bg-gradient-to-br from-[var(--primary-gradient-start)] to-[var(--primary-gradient-end)] text-white text-xl">
                ...
                <div className="flex items-center space-x-4">
                  <div>
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      {provider.isVerified && (
                        <CheckCircle className="w-6 h-6 text-[var(--primary-gradient-start)]" />
                      )}
                    </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {provider.skills.map((skill) => (
                    <Badge 
                      key={skill}
                      variant="outline" 
                      className="bg-[var(--primary-gradient-start)]/10 border-[var(--primary-gradient-start)]/30 text-[var(--primary-gradient-start)]"
                    >
                      {skill}
                    </Badge>
                  ))}
                ...
                <TabsContent value="experience" className="space-y-4">
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      <Award className="w-6 h-6 text-[var(--primary-gradient-start)]" />
                      <div>
                    ...
                    <Separator />
                    <div className="flex items-center space-x-3">
                      <Shield className="w-6 h-6 text-[var(--primary-gradient-start)]" />
                      <div>
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 bg-card border-2 border-border/40 shadow-lg sticky top-20">
              <div className="text-center mb-6">
                <p className="text-3xl font-bold text-[var(--primary-gradient-start)] mb-1">
              ...
              <div className="space-y-4 mb-6">
                ...
                <Button 
                  variant="outline" 
                  size="lg"
                  className="w-full border-2 border-[var(--primary-gradient-start)]/30 text-[var(--primary-gradient-start)] hover:bg-[var(--primary-gradient-start)]/5"
                >
